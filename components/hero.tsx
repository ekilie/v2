      ...
      <section className="max-w-screen-xl mx-auto px-4 py-28 gap-12 md:px-8 flex flex-col justify-center items-center">
        ...
        >
          ...
          <p className="max-w-2xl text-lg mx-auto text-muted-foreground text-balance">
            Discover Ekilie&apos;s suite of advanced digital solutions designed to transform tomorrow&apos;s technology. From intelligent sensing to seamless communication, we pioneer innovations that drive the future.
          </p>
          <motion.div
          ...
          >
            ...
            >
              <ModalContent>
                ...
                <ModalBody>
                  We are pioneers in digital innovation, developing cutting-edge solutions including ekiliSense, ekiliRelay, ekiliConvo, and comprehensive Insights platforms. Our mission is to shape the future of technology through intelligent design and forward-thinking solutions.
                </ModalBody>
                <ModalFooter>
                  <Button
                    as={Link}
